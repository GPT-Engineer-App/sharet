...
**Project**: trello-sharecraft 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: I would like to build an external share for Trello cards. It should have all the features and layouts that you would see in this screen shot.  
...
```sh
git clone https://github.com/GPT-Engineer-App/trello-sharecraft.git
cd trello-sharecraft
npm i
